    ...
    <div className={styles.page}>
      ...
      <nav className={styles.nav}>
        <div className={styles.navInner}>
          <Link className={styles.navTab} href="/dashboard.html">Board</Link>
          <Link className={styles.navTab} href="/record.html">Record</Link>
          <Link className={styles.navTab} href="/drinks.html">Drinks</Link>
          <Link className={styles.navTab} href="/summary.html">Summary</Link>
          <Link className={`${styles.navTab} ${styles.navTabActive}`} href="/analytics">Analytics</Link>
          <Link className={styles.navTab} href="/settings.html">Settings</Link>
        </div>
      </nav>
    </div>
  );
